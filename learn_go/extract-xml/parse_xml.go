/*
// extract hostname and IP from nmap file (scan.xml)
// and Println to host.txt
// Format: 0.0.0.0    # hostname
// original code from: https://github.com/lair-framework/go-nmap  
*/
...
// Smurf contains repsonse from a smurf attack. I think.
